        ...
        <div className="fixed inset-0 z-[170] pointer-events-none" style={{ direction: 'ltr' }}>
          ...
          >
            ...
            {currentUser ? (
                  ...
                  <div className="flex items-center gap-3 min-w-0">
                    {currentUser.photoURL && !hidePhoto ? (
                      <img 
                        ...
                        className="w-11 h-11 rounded-full border-2 border-amber-400 shrink-0 object-cover shadow-sm" 
                      />
                    ) : (
                      <div className="w-11 h-11 rounded-full bg-amber-500/25 text-amber-700 dark:text-amber-300 border border-amber-500/40 flex items-center justify-center font-black text-base shrink-0 shadow-sm">
                        {(currentUser.displayName || currentUser.email || 'U').substring(0, 1).toUpperCase()}
                      </div>
                    )}
                    <div className="min-w-0">
                      <div className="flex items-center gap-1.5">
                        <span className="font-black text-sm text-stone-900 dark:text-white truncate block">
              ...
              <div className="mx-4 sm:mx-5 mt-4 sm:mt-5 p-4 bg-gradient-to-br from-amber-500/15 via-[#f9f5ed] to-[#f4eee4] dark:from-stone-800/90 dark:via-stone-850 dark:to-stone-900 border border-amber-500/40 dark:border-stone-700 rounded-2xl shadow-sm shrink-0">
                <div className="flex items-start justify-between gap-2 mb-3">
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="px-2 py-0.5 bg-amber-500/20 text-amber-700 dark:text-amber-300 text-[9px] font-bold rounded">
                        تایبەت
                      </span>
                    </div>
                    <p className="text-xs text-stone-600 dark:text-stone-400 font-medium mt-1 leading-relaxed">
                ...
                <button
                  ...
                  className="w-full py-3 px-4 bg-white hover:bg-stone-50 dark:bg-stone-800 dark:hover:bg-stone-700/90 text-stone-800 dark:text-white border border-stone-300 dark:border-stone-600 rounded-xl font-black text-xs sm:text-sm flex items-center justify-center gap-2.5 transition-all shadow-sm hover:shadow active:scale-98 cursor-pointer disabled:opacity-60"
                >
                  {isSigningInGoogle ? (
                    <>
                    ...
                    <>
                      ...
                      <span>چوونەژوورەوە بە گووگڵ (Sign In)</span>
                    </>
                  )}
                </button>
              </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-3">
              ...
              {!currentUser && (
                ...
                >
                  <div className="flex items-center gap-3.5">
                    <div className="w-11 h-11 rounded-2xl bg-white dark:bg-stone-900 flex items-center justify-center shrink-0 border border-stone-200 dark:border-stone-700 shadow-sm">
                      {isSigningInGoogle ? (
                    ...
                    <div>
                      <span className="font-black text-base text-stone-900 dark:text-amber-300 block">
                        چوونەژوورەوە بە گووگڵ
                      </span>
                  ...
                  <div className="px-3 py-1.5 bg-amber-500 text-stone-950 font-black text-xs rounded-xl shadow-sm shrink-0">
                    Sign In
                  </div>
                </button>
              )}
              ...
              <button
                ...
                className="w-full p-4 rounded-2xl bg-[#fdfcf9] hover:bg-[#f3ede1] dark:bg-stone-800/80 dark:hover:bg-stone-800 border border-stone-200/90 dark:border-stone-700/60 flex items-center justify-between transition-all cursor-pointer group text-right shadow-sm active:scale-98"
              >
                <div className="flex items-center gap-3.5">
                  <div className="w-11 h-11 rounded-2xl bg-amber-500/15 text-amber-600 dark:text-amber-400 flex items-center justify-center shrink-0 border border-amber-500/30">
                    <Trophy className="w-6 h-6" />
                  </div>
                  <div>
                    <span className="font-black text-base text-stone-900 dark:text-amber-300 block">ڕیزبەندی یاریزانان</span>
                    <span className="text-xs text-stone-500 dark:text-stone-400 font-medium">زۆرترین بردنەوە و کۆی یارییەکان</span>
                  </div>
                </div>
                <ChevronLeft className="w-5 h-5 text-stone-400 group-hover:text-amber-600 dark:group-hover:text-amber-400 group-hover:-translate-x-1 transition-all" />
              </button>
              ...
              >
                <div className="flex items-center gap-3.5">
                  <div className="w-11 h-11 rounded-2xl bg-sky-500/15 text-sky-600 dark:text-sky-400 flex items-center justify-center shrink-0 border border-sky-500/30">
                    <Globe2 className="w-6 h-6" />
                  </div>
                  <div>
                    <span className="font-black text-base text-stone-900 dark:text-sky-300 block">یاری ئۆنلاین</span>
                    <span className="text-xs text-stone-500 dark:text-stone-400 font-medium">یاری ڕاستەوخۆ لەگەڵ هاوڕێکانت</span>
                  </div>
                </div>
                <ChevronLeft className="w-5 h-5 text-stone-400 group-hover:text-sky-600 dark:group-hover:text-sky-400 group-hover:-translate-x-1 transition-all" />
              </button>
              ...
              >
                <div className="flex items-center gap-3.5">
                  <div className="w-11 h-11 rounded-2xl bg-red-500/15 text-red-600 dark:text-red-400 flex items-center justify-center shrink-0 border border-red-500/30">
                    <Gamepad2 className="w-6 h-6" />
                  </div>
                  <div>
                    <span className="font-black text-base text-stone-900 dark:text-red-300 block">دەستپێکردنی یاری ناوخۆیی</span>
                    <span className="text-xs text-stone-500 dark:text-stone-400 font-medium">یاریکردن لەسەر یەک ئامێر (٢-٦ یاریزان)</span>
                  </div>
                </div>
                <ChevronLeft className="w-5 h-5 text-stone-400 group-hover:text-red-600 dark:group-hover:text-red-400 group-hover:-translate-x-1 transition-all" />
              </button>
              ...
              >
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    <span className="font-black text-base text-stone-900 dark:text-amber-300 block">یاساکانی یاری</span>
                    <span className="text-xs text-stone-500 dark:text-stone-400 font-medium">ڕێنمایی و یاساکانی چۆنیەتی بردنەوە</span>
                  </div>
                </div>
                <ChevronLeft className="w-5 h-5 text-stone-400 group-hover:text-amber-600 dark:group-hover:text-amber-400 group-hover:-translate-x-1 transition-all" />
              </button>

              {/* 5. TikTok Official Page Link */}
              <a
              ...
              >
                <div className="flex items-center gap-3.5">
                  <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-[#00f2fe] to-[#4facfe] text-stone-950 flex items-center justify-center shrink-0 shadow-sm group-hover:scale-105 transition-transform">
                    {/* Official TikTok Icon */}
                    <svg className="w-6 h-6 fill-stone-950" viewBox="0 0 24 24">
              ...
              >
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    <span className="font-black text-base text-stone-900 dark:text-red-300 block">ڕاپۆرتکردنی کێشە لە یاری</span>
                    <span className="text-xs text-stone-500 dark:text-stone-400 font-medium">پێشنیار یان کێشەیەک ڕابگەیەنە</span>
                  </div>
                </div>
                <ExternalLink className="w-5 h-5 text-stone-400 group-hover:text-red-500 transition-colors shrink-0" />
              </a>
              ...
              {isAndroid && (
                ...
                >
                  <div className="flex items-center gap-3.5">
                    ...
                    <div>
                      <span className="font-black text-base text-stone-900 dark:text-emerald-300 block">داگرتنی ئەپی ئەندرۆید (APK)</span>
                      <span className="text-xs text-stone-500 dark:text-stone-400 font-medium">دامەزراندنی فایلی APK ڕاستەوخۆ</span>
                    </div>
                  </div>
                  <ChevronLeft className="w-5 h-5 text-stone-400 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 group-hover:-translate-x-1 transition-all" />
                </button>
              )}
              ...
              >
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    <span className="font-black text-base text-stone-900 dark:text-stone-200 block">
                ...
                <div className={`px-3 py-1.5 rounded-xl text-xs font-black transition-colors ${
                  isSoundMuted 
              ...
              >
                ...
                <div className="px-3 py-1.5 rounded-xl text-xs font-black bg-stone-200 dark:bg-stone-700 text-stone-700 dark:text-stone-200">
            ...
            <div className="p-4 sm:p-5 border-t border-stone-200 dark:border-stone-800 bg-[#f4eee4] dark:bg-stone-950/50 text-center shrink-0">
              <p className="text-xs text-stone-600 dark:text-stone-400 font-black">
